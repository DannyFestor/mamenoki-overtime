<div class="w-full max-w-7xl mx-auto flex flex-col gap-4">
    ...
    <form wire:submit="submit" class="w-full max-w-lg mx-auto flex flex-col divide-y-2 divide-slate-200 gap-4 border-2 border-sky-900">
        <div class="flex flex-col p-4">
            ...
            <input wire:model="form.date" name="date" type="date" class="form-input">
            @error('form.date')
            {{ $message }}
            @enderror
        ...
        <div class="flex flex-col p-4">
            ...
            <div class="flex w-full">
                <input wire:model="form.timeFrom" name="time_from" type="text" class="form-input w-[45%]">
        ...
        <div class="flex justify-center gap-4 p-4">
            ...
            <button wire:click="saveDraft" type="button"
                    class="w-20 h-20 rounded-full border-4 border-amber-300 bg-amber-100 text-amber-800 flex justify-center items-center"
            >一時保存</button>
        </div>
    </form>
</div>
