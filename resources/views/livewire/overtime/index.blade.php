<div class="w-full max-w-7xl mx-auto flex flex-col gap-4">
    ...
    <div class="w-full flex gap-4">
        ...
        <div class="flex-1 flex flex-col gap-4">
            <a wire:navigate href="{{ route('overtime.create') }}" class="w-full border-2 border-sky-900 px-4 py-2 text-xl flex justify-center items-center gap-2 hover:bg-sky-100">
                新規作成 <x-svgs.plus-circle />
            </a>
        </div>
    </div>
</div>
