...
<div class="w-full max-w-4xl mx-auto">
    <div class="flex">
        <div class="flex-1">{{ $overtimeConfirmation->japaneseYear }}年度 時間外勤務命令簿</div>
        <div class="font-xl">{{ $overtimeConfirmation->month }}月分</div>
    </div>
    ...
    <table class="table-fixed w-full mt-4">
        ...
        <tbody>
        @foreach($overtimeConfirmation->overtimes as $overtime)
            <tr>
        ...
        <div class="flex items-center">
            <div class="border-4 border-emerald-500 flex flex-col">
                ...
                <div class="p-4 text-center">
                    {{ $user->name }}<br>
                    {{ $overtimeConfirmation->confirmed_at }}
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-1 flex-col gap-2 p-4 w-full sm:w-1/2">
            <div class="flex flex-col">
                ...
                <textarea disabled id="form_remarks"
                          rows="3" class="form-textarea">{{ $overtimeConfirmation->remarks }}</textarea>
            </div>
            <div class="flex flex-col">
                ...
                <textarea disabled rows="3"
                          class="form-textarea">{{ $overtimeConfirmation->transfer_remarks }}</textarea>
            </div>
        </div>
    </div>
</div>
